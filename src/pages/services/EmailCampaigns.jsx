...
const EmailCampaigns = () => {
  return (
    <section className="bg-[#f9fafb] text-gray-800 py-20 px-6 md:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Services Section */}
        <div>
          <h2 className="text-3xl font-bold mb-6">ProRiterz Email Campaign Services</h2>
        ...
        {/* Campaign Types */}
        <h2 className="text-3xl font-bold mb-6">Types of Email Campaigns We Offer</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">

          {/* Card 1 */}
          <div className="bg-[#f0f8ff] p-6 rounded-xl shadow-md">
        ...
        {/* CTA Section */}
        <div className="bg-[#e0f4ff] p-10 rounded-xl text-center shadow-md">
