...
const EcommerceSEO = () => {
  return (
    <section className="bg-[#f8fafc] py-20 px-6 md:px-12 lg:px-24 text-gray-800">
      <div className="max-w-6xl mx-auto">
        {/* Title */}
        <h1 className="text-4xl md:text-5xl font-extrabold mb-6 text-center">
          The Power of <span className="text-[#2ea9ff]">E-commerce SEO</span> in 2025
        </h1>

        {/* Did You Know */}
        <div className="bg-white shadow-md rounded-xl p-6 mb-12 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-[#e0f4ff] p-6 rounded-xl shadow">
        ...
        {/* Section Title */}
        <h2 className="text-3xl font-bold mb-6">How Pro-Riterz Optimizes Your Online Store</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition duration-300">
            <FaSearch className="text-3xl text-[#2ea9ff] mb-4" />
          ...
          {/* Card 2 */}
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition duration-300">
            <FaTags className="text-3xl text-[#2ea9ff] mb-4" />
          ...
          {/* Card 3 */}
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition duration-300">
            <FaPenFancy className="text-3xl text-[#2ea9ff] mb-4" />
          ...
          {/* Card 4 */}
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition duration-300">
            <FaLink className="text-3xl text-[#2ea9ff] mb-4" />
        ...
        <div className="mb-16">
          ...
          <div className="space-y-4">
            <details className="border rounded-md p-4 cursor-pointer">
              ...
              <p className="mt-2 text-gray-600">Most stores begin to see significant improvements within 3–6 months.</p>
            </details>
            <details className="border rounded-md p-4 cursor-pointer">
              <summary className="font-medium">🛍️ Can you help with small or niche e-commerce stores?</summary>
              <p className="mt-2 text-gray-600">Yes! We specialize in tailored strategies no matter your store size or niche.</p>
            </details>
            <details className="border rounded-md p-4 cursor-pointer">
              <summary className="font-medium">🌍 Do you handle international SEO for e-commerce?</summary>
              <p className="mt-2 text-gray-600">Absolutely. We optimize for multilingual, multi-region SEO performance.</p>
            </details>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-3"><strong>Sustainable Traffic:</strong> SEO delivers traffic that doesn’t disappear when your ad budget runs out.</p>
            <p className="text-gray-700 mb-3"><strong>Higher ROI:</strong> Businesses that invest in SEO consistently outperform ad-only strategies.</p>
            <p className="text-gray-700"><strong>Credibility:</strong> 70% of users trust organic results more than ads—making SEO essential.</p>
          </div>
        </div>

        {/* CTA Section */}
        <div className="bg-[#e0f4ff] p-8 rounded-xl text-center shadow-md">
          ...
          <button className="mt-6 px-6 py-3 bg-[#2ea9ff] text-white font-semibold rounded-lg hover:bg-[#199fe0] transition">
            Get My Free SEO Consultation
          </button>
        </div>
      </div>
      </div>
