  ...
  return (
    <div className="bg-gradient-to-r from-black via-[#0b223f] to-[#06263f] px-6 py-20 relative overflow-hidden">
      ...
      <div className="relative flex flex-col md:flex-row justify-center gap-6 mt-6 z-10">
        <Link to="/portfolio/ocs" className="relative bg-[#f4eee7] text-black rounded-xl overflow-hidden group transform transition hover:scale-105 shadow-lg w-full md:w-1/2 lg:w-1/3">
        ...
        <Link to="/portfolio/cb2b" className="relative bg-[#d3e8f8] text-black rounded-xl overflow-hidden group transform transition hover:scale-105 shadow-lg w-full md:w-1/2 lg:w-1/3">
